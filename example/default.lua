Citizen.CreateThread(function()
    ...
    while true do
        ...
        if RageUI.Visible(NewMenu) then
            ...
            RageUI.List("List", { 0, 0, 0 }, Indexes[2], "Save your current settings. All saving is done on the client side, if you re-install windows you will lose your settings. Settings are shared across all servers using vMenu.", true, function(Hovered, Active, Selected, Index)
                Indexes[2] = Index
            end)
