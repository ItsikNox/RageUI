    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
          ...
          --  Percent = Percent * 100
           ...
           ---RenderSprite(Statistics.Background.Dictionary, Statistics.Background.Texture, CurrentMenu.X, CurrentMenu.Y + Statistics.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, Statistics.Background.Width + CurrentMenu.WidthOffset, Statistics.Background.Height)
