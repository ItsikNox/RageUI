...
function RageUI.GridPanel(X, Y, TopText, BottomText, LeftText, RightText, Callback)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            ...
            RageUI.RenderSprite(RageUI.Settings.Panels.Grid.Background.Dictionary, RageUI.Settings.Panels.Grid.Background.Texture, CurrentMenu.X, CurrentMenu.Y + RageUI.Settings.Panels.Grid.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, RageUI.Settings.Panels.Grid.Background.Width + CurrentMenu.WidthOffset, RageUI.Settings.Panels.Grid.Background.Height)
            RageUI.RenderSprite(RageUI.Settings.Panels.Grid.Grid.Dictionary, RageUI.Settings.Panels.Grid.Grid.Texture, CurrentMenu.X + RageUI.Settings.Panels.Grid.Grid.X + (CurrentMenu.WidthOffset / 2), CurrentMenu.Y + RageUI.Settings.Panels.Grid.Grid.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, RageUI.Settings.Panels.Grid.Grid.Width, RageUI.Settings.Panels.Grid.Grid.Height)
            ...
            RageUI.RenderText(TopText or "", CurrentMenu.X + RageUI.Settings.Panels.Grid.Text.Top.X + (CurrentMenu.WidthOffset / 2), CurrentMenu.Y + RageUI.Settings.Panels.Grid.Text.Top.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, RageUI.Settings.Panels.Grid.Text.Top.Scale, 245, 245, 245, 255, 1)
            ...
            RageUI.RenderText(LeftText or "", CurrentMenu.X + RageUI.Settings.Panels.Grid.Text.Left.X + (CurrentMenu.WidthOffset / 2), CurrentMenu.Y + RageUI.Settings.Panels.Grid.Text.Left.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, RageUI.Settings.Panels.Grid.Text.Left.Scale, 245, 245, 245, 255, 1)
            RageUI.RenderText(RightText or "", CurrentMenu.X + RageUI.Settings.Panels.Grid.Text.Right.X + (CurrentMenu.WidthOffset / 2), CurrentMenu.Y + RageUI.Settings.Panels.Grid.Text.Right.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, RageUI.Settings.Panels.Grid.Text.Right.Scale, 245, 245, 245, 255, 1)
