...
function RageUI.PercentagePanel(Percent, HeaderText, MinText, MaxText, Callback)
    if RageUI.CurrentMenu ~= nil then
        if RageUI.CurrentMenu() then
            ...
            RageUI.RenderRectangle(RageUI.CurrentMenu.X + RageUI.Settings.Panels.Percentage.Bar.X + (RageUI.CurrentMenu.WidthOffset / 2), RageUI.CurrentMenu.Y + RageUI.Settings.Panels.Percentage.Bar.Y + RageUI.CurrentMenu.SubtitleHeight + RageUI.ItemOffset, Progress, RageUI.Settings.Panels.Percentage.Bar.Height, 245, 245, 245, 255)

            RageUI.RenderText(HeaderText or "Opacity", RageUI.CurrentMenu.X + RageUI.Settings.Panels.Percentage.Text.Middle.X + (RageUI.CurrentMenu.WidthOffset / 2), RageUI.CurrentMenu.Y + RageUI.Settings.Panels.Percentage.Text.Middle.Y + RageUI.CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, RageUI.Settings.Panels.Percentage.Text.Middle.Scale, 245, 245, 245, 255, 1)
            RageUI.RenderText(MinText or "0%", RageUI.CurrentMenu.X + RageUI.Settings.Panels.Percentage.Text.Left.X + (RageUI.CurrentMenu.WidthOffset / 2), RageUI.CurrentMenu.Y + RageUI.Settings.Panels.Percentage.Text.Left.Y + RageUI.CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, RageUI.Settings.Panels.Percentage.Text.Left.Scale, 245, 245, 245, 255, 1)
            RageUI.RenderText(MaxText or "100%", RageUI.CurrentMenu.X + RageUI.Settings.Panels.Percentage.Text.Right.X + (RageUI.CurrentMenu.WidthOffset / 2), RageUI.CurrentMenu.Y + RageUI.Settings.Panels.Percentage.Text.Right.Y + RageUI.CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, RageUI.Settings.Panels.Percentage.Text.Right.Scale, 245, 245, 245, 255, 1)
