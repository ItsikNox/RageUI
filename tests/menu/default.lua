Citizen.CreateThread(function()
    ...
    while true do
        ...
        if RageUI.Visible(mainMenu) then
            RageUI.Header();
            RageUI.Button("Colored Item", Description, { LeftBadge = RageUI.BadgeStyle.Gun, RightBadge = RageUI.BadgeStyle.Heart, RightLabel = "→→→", Color = RageUI.Colours.HbYellow }, true, function(Hovered, Active, Selected)
            end)
            for i = 1, 50 do
